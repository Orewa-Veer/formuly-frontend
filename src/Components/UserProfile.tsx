...
import { MdVerticalDistribute, MdVerticalSplit } from "react-icons/md";
...
const UserProfile = () => {
  ...
  return (
    <div className="p-3 sm:px-6 md:px-8 lg:px-10 xl:px-14">
      {/* User Card  */}
      <div className="flex justify-around px-10 backdrop-blur-md shadow-lg rounded-sm bg-white/10 border border-white/20">
        {/* left image  */}
      ...
      <div className="flex flex-col gap-4 mt-6">
        {/* Header  */}
        <div className="text-xl font-bold border ">
          <Button variant="outline" className="bg-gray-200 px-2">
            My Posts
          </Button>
        </div>
        <div>
