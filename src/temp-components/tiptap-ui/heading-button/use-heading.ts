...
// --- Icons ---
import { HeadingOneIcon } from "@/temp-components/tiptap-icons/heading-one-icon";
import { HeadingTwoIcon } from "@/temp-components/tiptap-icons/heading-two-icon";
import { HeadingThreeIcon } from "@/temp-components/tiptap-icons/heading-three-icon";
import { HeadingFourIcon } from "@/temp-components/tiptap-icons/heading-four-icon";
import { HeadingFiveIcon } from "@/temp-components/tiptap-icons/heading-five-icon";
import { HeadingSixIcon } from "@/temp-components/tiptap-icons/heading-six-icon";
